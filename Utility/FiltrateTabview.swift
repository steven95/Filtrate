...
class FiltrateTabview: UIView {
    ...
    private   lazy var centerTableView: UITableView = {
        ...
        centerTableView.backgroundColor = JSHexColor(Hex: 0xF8F9FA, alpha: 1)
    ...
    private lazy var rightTableView: UITableView = {
        ...
        rightTableView.backgroundColor = JSHexColor(Hex: 0xF8F9FA, alpha: 1)
