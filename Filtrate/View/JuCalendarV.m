...
-(void)OnTapBeginView:(UIGestureRecognizer *)tap{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        weakSelf.chooseDateView.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
    } completion:nil];
...
-(void)cancal{
    WEAKSELF
    [UIView animateWithDuration:0.3 animations:^{
        weakSelf.chooseDateView.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.height, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
...
{
    if (!_popBackview) {
        _popBackview = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height)];
...
-(OldHouseDatePickerView *)chooseDateView{
    if (!_chooseDateView) {
        ...
        _chooseDateView.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.height, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
        WEAKSELF
