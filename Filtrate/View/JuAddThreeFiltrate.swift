...
public struct JIndexPath: Hashable {
    ...
    public init(_left:Int,_cen:Int,_right:Int){
        left = _left
        cen = _cen
        right = _right
    }
...
public class AddthreeFiltrateTabview: UIView {

    public var lArray:[FiltrateModel] = []
    ...
    public var cArray:[FiltrateModel] = []
    ...
    public var rArray:[FiltrateModel] = []
    ...
    public func  seleType( _ array:[FiltrateModel] ) -> iSeleType {
    ...
    public var leftPath = IndexPath.init(row: 0, section: 0)
    public var centerPath = IndexPath.init(row: 0, section: 0)
    public var rightPath = IndexPath.init(row: 0, section: 0)
...
public class JuAddThreeFiltrate: NSObject {
  
    public class var shared : JuAddThreeFiltrate {
    ...
    public  func reSet(lefts: [FiltrateModel], cens: [[FiltrateModel]], rights: [[[FiltrateModel]]])  {
    ...
    public func deleCell(lefts: [FiltrateModel],cens: [[FiltrateModel]],rights: [[[FiltrateModel]]], groupStrs:[String],
 ...
 if iPaths.count ==  1 { ///操作第一级**
    ...
    public class func showInWindow(lefts: [FiltrateModel],cens: [[FiltrateModel]],rights: [[[FiltrateModel]]], groupStrs:[String],
